...
# ==============================================================================
    ...
    def replaceText(self, node, rstPrefix): # pylint: disable=R0201
        return None

    def preText(self, node, rstPrefix):     # pylint: disable=R0201
        return None

    def postText(self, node, rstPrefix):    # pylint: disable=R0201
        return None
